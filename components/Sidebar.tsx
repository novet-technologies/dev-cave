...
export function Sidebar() {
    ...
    <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
      ...
      <ScrollArea className="flex-1">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2">
              {friends.map((friendship) => (
                <button
                  key={friendship.id}
                  onClick={() => handleChatSelect(friendship.friend.id, 'friend')}
                  className={`w-full p-3 rounded-lg text-left transition-colors ${
                    currentChat === friendship.friend.id && chatType === 'friend'
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className="relative">
                      ...
                      <div className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border-2 border-white ${getStatusColor(friendship.friend.status)}`} />
                    </div>
              ...
              {friends.length === 0 && !loading && (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-xs">Search and add friends to start chatting</p>
                </div>
              )}
            </div>
          </div>
        ...
        {activeTab === 'groups' && (
          <div className="p-4 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-medium text-gray-900">Groups ({groups.length})</h3>
              <Button
                size="sm"
            ...
            <div className="space-y-2">
              ...
              {groups.length === 0 && !loading && (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-xs">Create or join groups to collaborate</p>
                </div>
              )}
            </div>
          </div>
        ...
        {activeTab === 'requests' && (
          <div className="p-4 space-y-4">
            <h3 className="font-medium text-gray-900">Friend Requests ({friendRequests.length})</h3>
  ...
  async function handleFriendResponse(requestId: string, action: 'accept' | 'reject') {
    try {
